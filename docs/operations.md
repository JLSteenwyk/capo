...
| Worker cleanup could not be confirmed | Inspect private attempt diagnostics and current process groups before retrying. A denied group probe does not prove that the worker stopped. |
