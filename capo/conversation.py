    ...
    def _run(self, directory, context, schema, fd):
        try:
            ...
            prompt = (STYLE + f"Current local time: {now}. Timezone: {zone}. " +
                ...
                "general information requests, personal tasks/reminders, daily/weekly planning, and tasks that combine sources such as email and calendar. "
                "Research discovers shared tools, manages personal tasks and saves private documents. "
                ...
                "Choose calendar for reading or changing Google Calendar events, including follow-up details; use research for work planning and task reminders. "
                "Use research when calendar actions require finding facts outside the calendar, interpreting uncertain event dates, or coordinating multiple sources. "
                "Research has web search, page reading, date arithmetic and authorized calendar changes. Preserve the full original request from request_state across follow-ups. "
                "Missing researchable facts require investigation, not an immediate question to the owner. "
